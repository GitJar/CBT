...
$config['versi']                = "_";           //isi sesuai kebutuhan nama pada header
$config['tgl']                  = "Purworejo, 22 Maret 2022";
$config['tampil_nilai']         = FALSE;            // jika siswa boleh melihat hasil ujian, isikan TRUE, jika tidak FALSE, default TRUE
$config['nama_sekolah']         = "MTs NEGERI 3 PURWOREJO"; //isi sesuai kebutuhan nama sekolah
$config['nama_ujian']           = "TES AKADEMIK"; //isi sesuai kebutuhan jenis ujian
$config['nama_kepala']          = "Fitriana Aenun, S.Pd., M.Ed."; //isi sesuai nama kepala
$config['nip_kepala']           = "197106241997032001"; //isi sesuai nama kepala
