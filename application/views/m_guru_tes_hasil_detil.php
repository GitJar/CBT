      ...
      <table class="table table-bordered" id="datatabel">
        <thead>
          <tr>
            ...
            <th width="30%" rowspan="2" colspan="1">Nama Peserta</th>
            <th width="10%" rowspan="2" colspan="1">Jumlah Benar</th>
            <th width="10%" rowspan="2" colspan="1">Jumlah Salah</th>
            <th width="15%" rowspan="2" colspan="1">Nilai</th>
            <th width="15%" rowspan="2" colspan="1">Nilai Bobot</th>
            <th width="10%"rowspan="1" colspan="2">Aksi</th>
          </tr>
          <tr>
            <th width="10%"rowspan="1" colspan="1">Ujian</th>
            <th width="10%"rowspan="1" colspan="1">Waktu</th>
          </tr>
        </thead>
